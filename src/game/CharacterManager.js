...
export class CharacterManager{
  ...
  create(faction,name='Vô Danh'){
    ...
    if(!this.characters[id])this.characters[id]={id,faction,name,realm:'qi_refining',realmName:'Luyện Khí Tầng 1',minorLevel:1,currentExp:0,maxExp:150,cultivationSystem:null,gold:0,inventory:[],equipment:{weapon:null,armor:null,accessory:null},allocatedStats:{strength:0,spirit:0,vitality:0,agility:0},skillSystem:null,currentRegion:'sect_hall'};
