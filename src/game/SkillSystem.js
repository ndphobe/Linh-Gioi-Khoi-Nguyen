...
export const SECT_SKILL_TREES = Object.freeze({
  ...
  demonic: Object.freeze([
    ...
    skill('blood_reaver', 'Huyết Sát Trảm', 'Huyết', 'Chém bóng tối bằng huyết sát cô đọng.', 'r', 'foundation', [{ damage: 72, manaCost: 38, cooldown: 11 }, { damage: 96, manaCost: 34, cooldown: 10 }, { damage: 126, manaCost: 30, cooldown: 8.8 }]),
    ...
    skill('abyss_feast', 'Vạn Hồn Phệ Thiên', 'Ma', 'Tuyệt kỹ nghiền nát mọi kẻ trong ma vực.', 'g', 'golden_core', [{ damage: 132, manaCost: 86, cooldown: 42 }, { damage: 176, manaCost: 77, cooldown: 38 }, { damage: 230, manaCost: 68, cooldown: 34 }]),
    ...
    skill('blood_moon','Huyết Nguyệt Diệt Thế','Nguyệt','Huyết nguyệt giáng thế nghiền nát sinh cơ quanh thân.','bloodmoon','spirit_transformation',[{damage:302,manaCost:100,cooldown:38},{damage:394,manaCost:90,cooldown:34},{damage:510,manaCost:80,cooldown:30}],{requiredLevel:13,unlockCost:4800,vfx:'bloodMoon',targetMode:'around-self',range:0,radius:9}),
    skill('blood_ravens','Huyết Nha Phệ Hồn','Nha','Đàn huyết nha truy sát mục tiêu bằng huyết hỏa.','ravens','nascent_soul',[{damage:132,manaCost:57,cooldown:17},{damage:176,manaCost:51,cooldown:15},{damage:230,manaCost:45,cooldown:13}],{shortName:'Huyết Nha',requiredLevel:7,unlockCost:950,vfx:'bloodRavens',targetMode:'single',range:16,radius:1.6}),
    ...
    skill('myriad_soul_banner','Vạn Hồn Ma Phiên','Phiên','Ma phiên triệu vạn hồn cắn xé quanh người.','soulbanner','spirit_transformation',[{damage:344,manaCost:92,cooldown:30},{damage:442,manaCost:82,cooldown:27},{damage:566,manaCost:72,cooldown:24}],{shortName:'Ma Phiên',requiredLevel:12,unlockCost:4000,vfx:'myriadSoulBanner',targetMode:'around-self',range:0,radius:10}),
    skill('world_blood_tide','Diệt Thế Huyết Triều','Triều','Huyết hải dâng trào cuốn sạch chiến trường.','bloodtide','spirit_transformation',[{damage:548,manaCost:122,cooldown:46},{damage:704,manaCost:109,cooldown:41},{damage:900,manaCost:96,cooldown:36}],{shortName:'Huyết Triều',requiredLevel:15,unlockCost:7400,vfx:'worldBloodTide',targetMode:'area',range:14,radius:9}),
  ]),
